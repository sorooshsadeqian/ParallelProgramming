...
class CPUInfo {
  public:
    ...
    bool isAES() const { return mIsAES; }
    bool isSHA() const { return mIsSHA; }
    bool isMMX() const { return mIsMMX; }
  ...
  private:
    ...
    static const uint32_t AES_POS = 0x00000020;
    static const uint32_t SHA_POS = 0x00000020;
    static const uint32_t MMX_POS = 0x00800000;
...
CPUInfo::CPUInfo() {
    ...
    mIsAES = cpuID1.ECX() & AES_POS;
    mIsSHA = cpuID1.EBX() & SHA_POS;
    mIsMMX = cpuID1.EDX() & MMX_POS;
...
string convertBoolToYesNo(bool b) {
    return b ? "Yes" : "No";
}
...
int main(int argc, char *argv[]) {
    ...
    cout << "CPU Brand : " << cinfo.model() << endl;
    cout << "# of cores : " << cinfo.cores() << endl;
    cout << "# of logical cores : " << cinfo.logicalCpus() << endl;
    cout << "Is CPU Hyper threaded : " << convertBoolToYesNo(cinfo.isHyperThreaded()) << endl;
    cout << "Is SSE   Supported : " << convertBoolToYesNo(cinfo.isSSE()) << endl;
    cout << "Is SSE2  Supported : " << convertBoolToYesNo(cinfo.isSSE2()) << endl;
    cout << "Is SSE3  Supported : " << convertBoolToYesNo(cinfo.isSSE3()) << endl;
    cout << "Is SSE41 Supported : " << convertBoolToYesNo(cinfo.isSSE41()) << endl;
    cout << "Is SSE42 Supported : " << convertBoolToYesNo(cinfo.isSSE42()) << endl;
    cout << "Is AVX   Supported : " << convertBoolToYesNo(cinfo.isAVX()) << endl;
    cout << "Is AVX2  Supported : " << convertBoolToYesNo(cinfo.isAVX2()) << endl;
    cout << "Is AES   Supported : " << convertBoolToYesNo(cinfo.isAES()) << endl;
    cout << "Is SHA   Supported : " << convertBoolToYesNo(cinfo.isSHA()) << endl;
    cout << "Is MMX   Supported : " << convertBoolToYesNo(cinfo.isMMX()) << endl;
